...
export type WebGLTexture2DSource = HTMLCanvasElement | HTMLImageElement | HTMLVideoElement;
...
export function createUniform(gl: WebGLRenderingContext, program: WebGLProgram, type: WebGLUniformType, name: string, ...args: any) {
