...
<Note>
  <time className="opacity-50" datetime="2023-01-01">Jan 1, 2023</time>

Looking back at this write-up 4 years later, the problems and challenges described here feel as relevant as ever. Conversations about _solutions_ on the other hand are a little less heartening, often dominated by "blockchains" or cryptocurrencies.

That said, I'd encourage readers to think beyond those narrow possibilities.
For me, my excitement and hopes for peer-to-peer tools, and alternative
internet structures remains strong.

</Note>

<Image
  src="/log/2017/toward-a-distributed-web/awh-snap.svg"
  alt="A folder making a face like x_x"
  width="1280"
  height="640"
  priority
/>
...
<Image
  src="/log/2017/toward-a-distributed-web/first-web-server.jpg"
  alt="The first web server, at CERN in Geneva"
  width="2048"
  height="1536"
>
  Tim Berners-Lee’s NeXT workstation (
  [source](https://commons.wikimedia.org/wiki/File:First_Web_Server.jpg))
</Image>
...
<Image
  src="/log/2017/toward-a-distributed-web/structure-http.svg"
  alt="A diagram showing many nodes 'following' a central server."
  width="1280"
  height="683"
/>
...
<Image
  src="/log/2017/toward-a-distributed-web/google-data-center.jpg"
  alt="Aisles and aisles of servers, lights blinking in the dark."
  width="2000"
  height="1333"
>
  Google Data Center in Finland (
  [source](https://www.google.com/about/datacenters/gallery/#/tech))
</Image>
...
<Image
  src="/log/2017/toward-a-distributed-web/structure-bittorrent.svg"
  alt="An alternative structure diagram, where each node is connected to other nodes."
  width="1280"
  height="683"
/>
